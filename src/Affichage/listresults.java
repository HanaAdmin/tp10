...
public class listresults extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	    ...
	    public listresults() {
	        ...
	        model.addColumn("Num_elve ");
	        model.addColumn("Num_Cours");
	        model.addColumn("Note1");
	        model.addColumn("Note2");
	        model.addColumn("Note3");
	        model.addColumn("Moyenne");
	        TABLEPRO.setModel(model);
	        String requeteListe="select * from resultat";
	        try{
	            stListe=maconnexion.etablirconnection().createStatement();
	            ResultSet resultat =stListe.executeQuery(requeteListe);
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("num_elv"),resultat.getString("num_crs"),resultat.getString("Note1"),resultat.getString("Note2"),resultat.getString("Note3")});
	            }
