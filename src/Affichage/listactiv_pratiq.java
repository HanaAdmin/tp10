...
public class listactiv_pratiq extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	    ...
	    public listactiv_pratiq() {
	        ...
	        model.addColumn("Num_eleve");
	        model.addColumn("Nbre fois");
	       /* model.addColumn("Date_Nai");
	        model.addColumn("Poids");
	        model.addColumn("Annee");*/
	        TABLEPRO.setModel(model);
	        String requeteListe="select * from activite_pratiques";
	        try{
	            stListe=maconnexion.etablirconnection().createStatement();
	            ResultSet resultat =stListe.executeQuery(requeteListe);
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("niveau"),resultat.getString("num_elv"),resultat.getString("Nmbre_fois_act")});
	            }
