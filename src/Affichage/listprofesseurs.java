...
public class listprofesseurs extends javax.swing.JFrame{/*
	...
	private JButton bfer;
	 private String query = "SELECT  * FROM professeurs order by  nom asc";
	    ...
	    public listprofesseurs() {
	       ...
	       /* model.addColumn("Date_Nai");
	        ...
	        try{
	            ...
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("num_prof"),resultat.getString("nom"),resultat.getString("datentre"),resultat.getString("salaire")});
	            }
