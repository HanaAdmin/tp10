...
public class listEleve extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	    ...
	    public listEleve() {
	       ...
	       /* model.addColumn("Date_Nai");
	        ...
	        try{
	            ...
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("num_elv"), resultat.getString("nom_elv"),resultat.getString("pren"),resultat.getString("datNais"),resultat.getString("annee")});
	            }
	    ...
	    private void initComponents() {
	        ...
	        jLabel1.setText("Nom des professeurs");
