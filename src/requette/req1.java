	    ...
	    public req1() {
	       ...
	       /*model.addColumn("Poids");
	        ...
	        try{
	            ...
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("activites.Niveau"),resultat.getString("equipet"),resultat.getString("nom_elv"),resultat.getString("pren")});
	            }
