...
public class Fen_ajout_Professeurs extends JFrame implements ActionListener {
	...
	{ 
     ...
     JLabel lbnbr=new JLabel("date d'entree :");
     JLabel lbann=new JLabel("salaire :");
     JLabel lbT=new JLabel("INFORMATION PROFESSEURS :");
     
     
     txtnum=new JTextField();
     txtnom=new JTextField();
     txtdat=new JTextField("ZZZZ-YY-XX");
     txtsal=new JTextField("0.0");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==bten)
		{
			...
			n=txtnom.getText();
			p=txtdat.getText();
			Float d=Float.valueOf(txtsal.getText());
			
			
			String query="Insert into professeurs values('"+nu+"','"+n+"','"+p+"','"+d+"')";
