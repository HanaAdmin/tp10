...
public class fen_Resultats extends JFrame implements ActionListener{
	...
	private String req1E = " select DISTINCT num_elv from eleve";
	private String req2C = " select DISTINCT num_crs from  cours";
	...
	{ 
	   initCombo();
	  this.setTitle("Enregistrement_Resultat");
     ...
     JLabel lbNote3=new JLabel("Note3 :");
     JLabel lbnumc=new JLabel("numero_cours:");
     JLabel lbnume=new JLabel("Numero_eleve");
   ...
   cmbonumc.setBounds(200,30,120,25); p.add(cmbonumc);
     ...
     cmbonumc.setForeground(Color.black); cmbonumc.setPreferredSize(new Dimension( 400 , 200));
      ...
      lbNote1.setBounds(20,110,50,25);  p.add(lbNote1);  lbNote1.setFont(fe);
      txtNote1.setBounds(65,110,50,25);p.add(txtNote1);
      
      lbNote2.setBounds(130,110,50,25);   p.add(lbNote2);  lbNote2.setFont(fe);
      txtNote2.setBounds(185,110,50,25);p.add(txtNote2);
      
      lbNote3.setBounds(250,110,70,25);  p.add(lbNote3); lbNote3.setFont(fe);
      txtNote3.setBounds(300,110,50,25);p.add(txtNote3);
...
public void actionPerformed(ActionEvent a) {
	...
	String requete = "INSERT INTO resultat VALUES ('"+n2+"','"+n+"','"+nbr1+"','"+nbr2+"','"+nbr3+"')";
