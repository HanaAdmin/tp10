...
public class ges_eleve extends JFrame implements ActionListener {
	...
	{ 
     ...
     ann=new JButton("Terminer"); ann.setIcon(new ImageIcon("C:\\Users\\mohakalil\\Desktop\\img\\fer.gif"));
     ...
     supp.setIcon(new ImageIcon("C:\\Users\\mohakalil\\Desktop\\img\\Originals\\supp.png"));
    ...
    btModif.setIcon(new ImageIcon("C:\\Users\\mohakalil\\Desktop\\img\\modif.png"));
 ...
 //suppression
		...
		if(e.getSource()==btModif)
		{
			...
			String query="UPDATE  eleve  SET nom_elv='"+p+"', pren='"+pr+"',datNais='"+d+"',Poids='"+pd+"',annee="+an+" where  num_elv="+n+"";
   ...
   String query="SELECT * FROM eleve  WHERE num_elv='"+n+"'";
		...
		try {
			...
			{   txtnum.setText(rst.getString("num_elv"));
				...
				txtpd.setText(rst.getString("Poids"));
				txtann.setText(String.valueOf(rst.getInt("annee")));
